...
const LoginFormNoRedirect = ({ setAuthenticated, from, bgcolor, shadow, email, productPriceId, type, mode, title, params }) => {
...
export default LoginFormNoRedirect;