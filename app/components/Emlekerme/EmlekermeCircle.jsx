...
function Scene() {
    ...
    const materials = useLoader(MTLLoader, '/3D-CAD-erme-kor.mtl');
    
    // Load the OBJ file and apply the materials
    const obj = useLoader(OBJLoader, '/3D-CAD-erme-kor.obj', (loader) => {
...
export default function EmlekermeCircle() {
  return (
    <Canvas 
