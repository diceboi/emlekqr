...
export default function MainHero({ title }) {
  return (
    <section className="relative flex flex-col items-center bg-[--cream] py-16 px-4 min-h-[30vh]">
        <Image src={"/marvany-erme.webp"} fill style={{ objectFit: "cover", objectPosition: "20% 50%" }} className="mix-blend-multiply opacity-30"/>
