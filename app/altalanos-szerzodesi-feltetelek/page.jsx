...
export default function AltalanosSzerzodesiFeltetelekPage() {
  return (
    <section className="w-full lg:py-16 py-8 px-4">
      <div className="container m-auto">
        <div className="flex flex-col gap-4">
          <H1 classname={"text-[--rose] pb-16"}>Általános szerződési feltételek</H1>
          <Paragraph>
            Üdvözöljük honlapunkon! Köszönjük, hogy vásárlása során bennünket tisztel meg bizalmával! A
            www.emlek-qr.hu honlapot a Bokros Gabriella Zsuzsanna egyéni vállalkozó üzemelteti
            (továbbiakban Eladó/szolgáltató).
          </Paragraph>
          <Paragraph>
